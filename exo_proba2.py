...
# code 2.3
# Si on ne fait qu'un seul lancer, le compteur ne sert pas à grand chose car 
# on sait d'avance qu'il n'y a que 2 issues.
#
...
# exo 2.2
# Maintenant, rédigez le code qui indique toutes les issues possibles d'un lancer
#  de dé ainsi que le nombre total d'issues.
